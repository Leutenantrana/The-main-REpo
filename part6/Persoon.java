...
public class Persoon {
    ...
    public Persoon(String name, int age, int height, int weight, boolean isMale, String activityFactor) {
        this.name = name;
        this.age = age;
        this.weight = weight;
        this.height = height;
    ...
    public String toString() {
        return this.name + " age " + this.age + " years" + "with the activity factor :"+ this.getactivityFactor() + "  " + "the basal metabolic rate is " + this.BMR;
